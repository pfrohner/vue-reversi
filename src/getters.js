...
export const winner = (state, getters) =>  getters.whiteCount > getters.blackCount ? WHITE : BLACK
export const isTie = (state, getters) => getters.whiteCount === getters.blackCount
